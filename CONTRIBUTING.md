# Contributing to SlicerCustomAppTemplate

There are many ways to contribute to SlicerCustomAppTemplate.

- Submit a feature request or bug, or add to the discussion on the [SlicerCustomAppTemplate issue tracker][is]
- Submit a [Pull Request][pr] to improve SlicerCustomAppTemplate.

## The PR Process, and Related Gotchas

### How to submit a PR ?

If you are new to SlicerCustomAppTemplate development and you don't have push access to the SlicerCustomAppTemplate
...
When submitting a PR, make sure to add a `Cc: @SlicerCustomAppTemplate/developers` comment to
notify SlicerCustomAppTemplate developers of your awesome contributions. Based on the
...
- You do NOT have push access: A SlicerCustomAppTemplate core developer will integrate your PR.
...
[pr]: https://github.com/Kitware/SlicerCustomAppTemplate/merge_requests
[is]: https://github.com/Kitware/SlicerCustomAppTemplate/issues
