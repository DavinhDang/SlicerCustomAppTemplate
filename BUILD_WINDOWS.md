...
This document summarizes how to build and package SlicerCustomAppTemplate on Windows.
...
mkdir W
cd /c/W
git clone https://github.com/Kitware/SlicerCustomAppTemplate.git S
```
...
4. Open `C:\W\SR\SlicerCustomAppTemplate.sln`, select `Release` and build the project.
