# Build and Package SlicerCustomAppTemplate

This document summarizes how to build and package SlicerCustomAppTemplate on Linux.

SlicerCustomAppTemplate is a custom Slicer application. Reading the [3D Slicer Developer Documentation](https://slicer.readthedocs.io/en/latest/developer_guide/index.html) may help answer additional questions.
...
```sh
git clone https://github.com/Kitware/SlicerCustomAppTemplate.git
```
...
cmake \
  ...
  -S SlicerCustomAppTemplate \
  -B SlicerCustomAppTemplate-SuperBuild-Release
cd SlicerCustomAppTemplate-SuperBuild-Release
make -j<N>
```
...
Once the application is built, there will be an _inner build_ inside the _superbuild_ folder, located at `SlicerCustomAppTemplate-SuperBuild-Release/Slicer-build`. The application executable is contained in this _inner build_ folder.
